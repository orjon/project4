...
const App = ({ classes }) => (
  <div className={classes.appWrapper}>
    <header>
      ...
      <p>
        This is an example on how to build a simple modal window with React and
        JSS.
        <br />
        To close modal, click on [X] button on top right, ESC key, or simply
        outside the window.
      </p>

      <p>
        Click here to follow the step by step tutorial to build this component:
        <br />
        <a href="">
